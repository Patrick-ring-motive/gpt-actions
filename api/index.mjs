...
async function onRequest(req, res) {
  ...
  let wikiURLString = 'https://script.google.com/macros/s/AKfycbxC7sB6VHSpH4CxY49wSioMqK65WvEvWEVXL-AAZ38RJ4d-vSPa5vgdks6RIdr1t1KGFA/exec'+req.url.split('/wiki/')[1];
